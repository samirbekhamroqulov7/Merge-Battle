          ...
          <GameCard variant="elevated" className="p-6">
            {!success ? (
                  ...
                  <div className="p-3 bg-green-500/10 border border-green-500/20 rounded">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm">
                        <p className="font-medium text-green-600">После подтверждения:</p>
                        <p className="text-green-500/80">
                          Ваш игровой аккаунт будет создан автоматически с выбранным никнеймом
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <h2 className="text-xl font-bold text-primary mb-2">Аккаунт подтвержден!</h2>
                <p className="text-sm text-muted-foreground text-center mb-4">
                  Ваш игровой аккаунт создан. Перенаправляем в игру...
                </p>
              </div>
            )}
          </GameCard>
